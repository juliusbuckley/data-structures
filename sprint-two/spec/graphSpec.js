describe('graph', function() {
  ...
  it('should remove edges between nodes when there are  multiple edges', function() {
    graph.addNode(4);
    graph.addNode(5);
    graph.addNode(6);
    graph.addNode(7);
    ...
    expect(graph.hasEdge(5, 8)).to.equal(false);
  });
  ...
  it('should create multiple edges between nodes', function() {
    graph.addNode(2);
    graph.addNode(1);
    graph.addNode(3);
    graph.addEdge(3, 2);
